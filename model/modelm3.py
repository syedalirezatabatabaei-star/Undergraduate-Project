...
class CNN1M3 (nn.Module):
    def __init__(self):
        super( CNN1M3 , self).__init__()
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=3, bias=False)
        self.conv1_bn = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=48, kernel_size=3,bias=False)
        self.conv2_bn = nn.BatchNorm2d(48)
        self.conv3 = nn.Conv2d(in_channels=48, out_channels=64, kernel_size=3, bias=False)
        self.conv3_bn = nn.BatchNorm2d(64)
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=80, kernel_size=3, bias=False)
        ...
        self.fc1 = nn.Linear(in_features=11264, out_features=10,bias=False) #11264
